# This dockerfile uses extends image https://hub.docker.com/sinlov-go/badges
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/badges
ARG GO_ENV_ROOT_BUILD_BIN_NAME=badges
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/badges/main.go
